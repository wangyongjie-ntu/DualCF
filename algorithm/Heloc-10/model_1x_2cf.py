...
if __name__ == "__main__":
    ...
    dquery = np.load("../../data/Heloc-10/heloc_query.npy").astype(np.float32)
    dtest = np.load("../../data/Heloc-10/heloc_test.npy").astype(np.float32)
    dcf = np.load("../../data/Heloc-10/heloc-plaincf-l2.npy").astype(np.float32)
    dccf = np.load("../../data/Heloc-10/heloc-plainccf-l2.npy").astype(np.float32)
