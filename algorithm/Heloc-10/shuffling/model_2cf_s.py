...
if __name__ == "__main__":
    ...
    dcf = np.load("../../../data/Heloc-10/64/heloc-plaincf-l2.npy").astype(np.float32)
    dccf = np.load("../../../data/Heloc-10/64/heloc-plainccf-l2.npy").astype(np.float32)
    ...
    for seed in range(100):
        ...
        random.shuffle(a)
        idx = a[0:length]
        train_sx, train_sy = train_x[idx], train_y[idx]
