...
if __name__ == "__main__":
    ...
    dquery = np.load("../../../data/GMSC/implementation/gmsc_query_v1.npy").astype(np.float32)
    dtest = np.load("../../../data/GMSC/implementation/gmsc_test.npy").astype(np.float32)
    dcf = np.load("../../../data/GMSC/implementation/GMSC_query_cf_v1.npy").astype(np.float32)
    dccf = np.load("../../../data/GMSC/implementation/GMSC_query_2cf_v1.npy").astype(np.float32)
