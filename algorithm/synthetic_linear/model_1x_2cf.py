#Filename:	model_1x_2cf.py
#Author:	Wang Yongjie
#Email:		yongjie.wang@ntu.edu.sg
#Date:		Kam 16 Des 2021 03:15:58 
...
if __name__ == "__main__":
    ...
    dcf = np.load("../../data/synthetic_linear/synthetic-plaincf.npy").astype(np.float32)
    dccf = np.load("../../data/synthetic_linear/synthetic-plaincf-2.npy").astype(np.float32)
