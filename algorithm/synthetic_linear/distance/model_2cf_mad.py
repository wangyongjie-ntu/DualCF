...
if __name__ == "__main__":
    ...
    dcf = np.load("../../../data/synthetic_linear/MAD/synthetic-plaincf-mad.npy").astype(np.float32)
    dccf = np.load("../../../data/synthetic_linear/MAD/synthetic-plaincf2-mad.npy").astype(np.float32)
