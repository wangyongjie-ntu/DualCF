...
if __name__ == "__main__":
    ...
    dcf = np.load("../../../data/synthetic_linear/L1/synthetic-plaincf-l1.npy").astype(np.float32)
    dccf = np.load("../../../data/synthetic_linear/L1/synthetic-plaincf2-l1.npy").astype(np.float32)
