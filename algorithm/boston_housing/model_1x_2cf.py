...
if __name__ == "__main__":
    ...
    dcf = np.load("../../data/boston_housing/64/boston-plaincf-l2.npy").astype(np.float32)
    dccf = np.load("../../data/boston_housing/64/boston-plaincf2-l2.npy").astype(np.float32)
