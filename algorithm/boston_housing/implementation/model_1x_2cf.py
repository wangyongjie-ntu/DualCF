...
def train(model, iterator, optimizer, criterion, device):
    ...
    return epoch_loss / (len(iterator.dataset) * 3), acc
...
if __name__ == "__main__":
    ...
    dquery = np.load("../../../data/boston_housing/proto/boston_housing_query.npy").astype(np.float32)
    dtest = np.load("../../../data/boston_housing/proto/boston_housing_test.npy").astype(np.float32)
    dcf = np.load("../../../data/boston_housing/proto/boston_housing_query_cf.npy").astype(np.float32)
    dccf = np.load("../../../data/boston_housing/proto/boston_housing_query_2cf.npy").astype(np.float32)
