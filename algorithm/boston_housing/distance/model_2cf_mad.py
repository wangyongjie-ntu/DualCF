...
if __name__ == "__main__":
    ...
    dcf = np.load("../../../data/boston_housing/MAD/boston-plaincf-mad-v1.npy").astype(np.float32)
    dccf = np.load("../../../data/boston_housing/MAD/boston-plaincf2-mad-v1.npy").astype(np.float32)
