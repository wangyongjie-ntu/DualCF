...
if __name__ == "__main__":
    ...
    dcf = np.load("../../../data/synthetic_nonlinear/64/synthetic-plaincf.npy").astype(np.float32)
    dccf = np.load("../../../data/synthetic_nonlinear/64/synthetic-plaincf-2.npy").astype(np.float32)
    ...
    for seed in range(100):
        ...
        for epoch in range(epoches):
            ...
            if  epoch > 200 and train_acc > 0.9:
                break
