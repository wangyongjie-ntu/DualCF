...
if __name__ == "__main__":
    ...
    dcf = np.load("../../../data/synthetic_nonlinear/91/synthetic-plaincf.npy").astype(np.float32)
    dccf = np.load("../../../data/synthetic_nonlinear/91/synthetic-plaincf-2.npy").astype(np.float32)
