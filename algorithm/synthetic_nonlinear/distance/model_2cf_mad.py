...
if __name__ == "__main__":
    ...
    dcf = np.load("../../../data/synthetic_nonlinear/MAD/synthetic-plaincf-mad.npy").astype(np.float32)
    dccf = np.load("../../../data/synthetic_nonlinear/MAD/synthetic-plaincf2-mad.npy").astype(np.float32)
