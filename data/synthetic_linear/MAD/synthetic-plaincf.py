...
if __name__ == "__main__":
    ...
    saved_name = 'synthetic-plaincf-mad.npy'
    ...
    for i in range(len(squery_x)):
        ...
        results = cf.generate_counterfactuals(test_instance, cur_pred, init_final, scaler, thres = 0.1, _lambda = 3, lr = 0.0005, max_iter = 2000, mads = mads)
