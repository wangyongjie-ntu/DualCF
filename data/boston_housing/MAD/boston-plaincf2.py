...
if __name__ == "__main__":
    ...
    load_name = 'boston-plaincf-mad-v1.npy'
    saved_name = 'boston-plaincf2-mad-v1.npy'
    boston = load_boston()
    data = boston.data
    ...
    for i in range(len(scf_x)):
        print(i)
        test_instance = scf_x[i:i+1]
        ...
        results = cf.generate_counterfactuals(test_instance, cur_pred, init_final, scaler, thres = thres, _lambda = lambda_, lr = 0.0005, max_iter = 2000, mads = mads)
