...
if __name__ == "__main__":
    ...
    cf = np.load('boston-plaincf-l2.npy').astype(np.float32)
    ...
    for i in range(len(scf_x)):
        ...
        results = cf.generate_counterfactuals(test_instance, cur_pred, init_final, scaler, _lambda = 1, lr = 0.0004, max_iter = 5000, mads = None)
    ...
    np.save('boston-plain2cf-l2.npy', boston_cf)
