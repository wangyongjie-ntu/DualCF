...
if __name__ == "__main__":
    ...
    cf = np.load("./heloc-plaincf-l2.npy").astype(np.float32)
    ...
    for i in range(len(squery_x)):
        ...
        results = cf.generate_counterfactuals(test_instance, cur_pred, init_final, scaler, _lambda = 3, lr = 0.0004, max_iter = 5000, mads = None)
    ...
    np.save('heloc-plainccf-l2.npy', heloc_cf)
