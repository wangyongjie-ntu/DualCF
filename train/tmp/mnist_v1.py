...
if __name__ == "__main__":
    ...
    train_generator = datagen.flow_from_directory("../data/MNIST_V1/train", class_mode = "categorical", color_mode = "grayscale", target_size = (28, 28), batch_size = 128)
    test_generator = datagen.flow_from_directory("../data/MNIST_V1/test", class_mode = "categorical", color_mode = "grayscale", target_size = (28, 28), batch_size = 128)
    ...
    model.fit(train_generator, steps_per_epoch=int(total_samples / 128),  
        epochs= 100,
        verbose=1)

    _, acc = model.evaluate(test_generator, steps =total_samples, verbose = 0)
